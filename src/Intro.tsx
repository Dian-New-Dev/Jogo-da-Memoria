...
const Intro: React.FC<IntroProps> = ({propParaIntro}) => {
    ...
    return (
        ...
        <div id='paineis-container' className='w-full h-screen relative fonte-papyrus text-gray-800 text-lg font-bold'>
            <div>
                <div className='z-10 relative grid place-items-center fundo-de-pergaminho w-[400px] h-[640px] p-20'>
                    <p className=''>O Reino agoniza.</p>
                </div>
                
            </div>
            
            <div className='border z-0 absolute top-0 left-0 w-full h-screen grid place-items-center'>
                <img className='w-[80%]' src={"./assets/images/prototype/Intro/painel1ap.jpg"} alt="Ilustração de um reino egípcio antigo com estruturas decaindo em ruínas. Estilo artístico de desenho à mão, aspecto sutilmente sinistro." />
                
                <div className='hidden grid place-items-center fundo-de-pergaminho w-[400px] h-[640px] p-20'>
            ...
            <div>
                ...
                <div className='grid place-items-center fundo-de-pergaminho w-[400px] h-[640px] p-20'>
            ...
            <div>
                ...
                <div className='grid place-items-center fundo-de-pergaminho w-[400px] h-[640px] p-20 border border-red-50'>
