...
const GameLogic: React.FC <GameLogicProps> = ({faseAtual, setFaseAtual, setRenderizarGameLogic, setRenderizarDescricaoDasCartas, setIndexA, setIndexB}) => {
    ...
    //states para estilizacao conjunta de CartasReais e CartasAnom
        ...
        const [estilosDasFases] = useState <string[]> ([
            ...
            "p-4 grid gap-2 w-[40%] mapa-grid-fase8",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase9",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase10",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase11",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase12",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase13",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase14",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase15",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase16",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase17",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase18",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase19",
            "p-4 grid gap-2 w-[40%] mapa-grid-fase20",
        ])
